...
* Session 1: Introduction to Semantic Segmentation
    ...
    * Theory: 
        * Introduction to  semantic segmentation
            ...
            * Problem formulation of image segmentation
        * Introduction to VOC-2012 dataset
    
    * Coding: Explore VOC-2012 dataset with Python

* Session 2: Implement torch Dataset for VOC-2012 dataset
    * Theory:
        * PyTorch representation of images
        * PyTorch representation of segmentation mask
            * VOC-2012 original representation
...
* Topic 4: Building a Trainer for semantic segmentation
...
* Topic 5: Loss functions for semantic segmentation
